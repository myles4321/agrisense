...
OPENAI_API_KEY = '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'
...
def farminginfo():
    ...
    if request.method == 'POST' and form.validate_on_submit():
        ...
        user_message = f"give me 4 suggestions on what to plant considering that the average temperature range in my area during the growing season is {q1}, the rainfall our region gets is about {q2} and the crops that we previously planted was {q3} knowing that the crops that are currently in high demand in our local market is {q4} The retention of moisture of my soil is {q5} and the altitude of my farming location is {q6}"
        ...
        return render_template('farminginfo.html', title='farminginfo', form=form, assistant_response=assistant_response)
